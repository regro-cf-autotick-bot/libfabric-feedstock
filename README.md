...
pixi add libfabric libfabric-bin libfabric-devel libfabric1
# for installing globally
pixi global install libfabric libfabric-bin libfabric-devel libfabric1
```
...
It is possible to list all of the versions of `libfabric` available on your platform:
...
```
pixi search libfabric --channel conda-forge
```
